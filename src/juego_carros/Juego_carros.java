...
public class Juego_carros {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Bienvenidos Participantes...");

        //Numero de jugadores      
        Scanner in = new Scanner(System.in);
        System.out.println("Ingresa el numero de jugadores que desea crear");
        ...
        for (int i = 0; i < Numero_Jugadores; i++) {
            id = UUID.randomUUID();
            Id_jugador jugadorId = new Id_jugador(id);
            Nombre_Jugador = "jugador" + (i + 1);
            Nombre nombre = new Nombre(Nombre_Jugador);
            Nuevo_Juego.CrearJugador(jugadorId, nombre);
        }
       ...
       /* 
        ...
        //arreglo para carril
        Carril objcarril[] = new Carril[objpista.getCarriles()];
